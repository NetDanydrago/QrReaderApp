...
{
	public class TorchQR
	{
		readonly CameraControllerQR cameraController;
		readonly Context context;
		bool? hasTorch;

		public TorchQR(CameraControllerQR cameraController, Context context)
		{
		...
		public bool IsSupported
		{
			get
			{
				...
				if ((supportedFlashModes != null)
					...
					hasTorch = Permissions.IsDeclaredInManifest(global::Android.Manifest.Permission.Flashlight);
