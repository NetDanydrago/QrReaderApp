...
{
	public class CameraControllerQR
	{
		readonly Context context;
		readonly SurfaceTexture holder;
		readonly PageRenderer PageRender;
		readonly CameraEventsListenerQR cameraEventListener;
		int cameraId;
		IScannerSessionHost scannerHost;

		public CameraControllerQR(PageRenderer pageRender,SurfaceTexture surface, CameraEventsListenerQR cameraEventListener, IScannerSessionHost scannerHost)
		{
		...
		public void AutoFocus(int x, int y)
		{
			...
			var focusX = x / PageRender.Width * 2000 - 1000;
			var focusY = y / PageRender.Height * 2000 - 1000;
